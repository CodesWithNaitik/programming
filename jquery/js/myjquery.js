...
//     // in place of $(document).ready(function () {}) we can write $(function(){})
//     //  this helps us to function when our document is ready
//     // $ means jquery
//     console.log("We are using jquery")
//     // syntax
//     // $('selector').action
//     $('p').click();  //  work done when we click on p
//     $('p').click(function () {
//         console.log("you have clicked on paragraph", this)   //here this print the inner hrml
//         // $('p').hide()     hide all para
//         // $(this).hide();  //  hide specific p when we click on p
//     });
//     // $('#id').action;
//     // $('.class').action;
//     // other selector
